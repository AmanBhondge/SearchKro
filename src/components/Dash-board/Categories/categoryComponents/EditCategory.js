...
import { getCategories, updateCategory } from "../../../utils/AxiosApi";
    ...
    const fetchCategory = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          index: categoryData.index ? String(categoryData.index) : "", // Convert index to string
        });
        setError(null);
      } catch (err) {
