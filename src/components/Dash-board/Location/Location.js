...
const Location = () => {
  const locationData = [
    { id: 1, role: "Buyer", Location: "London", Region: "Europe", popular: "Positive" },
    { id: 2, role: "Buyer", Location: "Mumbai", Region: "asia", popular: "Negative" },
    { id: 3, role: "Seller", Location: "Berlin", Region: "Europe", popular: "Positive" },
    { id: 4, role: "Buyer", Location: "Toronto", Region: "North America", popular: "Positive" },
    { id: 5, role: "Buyer", Location: "Paris", Region: "Europe", popular: "Negative" },
    { id: 6, role: "Seller", Location: "Berlin", Region: "Europe", popular: "Positive" },
  ];
                ...
                <tbody>
                  {locationData.map((item) => (
                    <tr key={item.id} className="border-b border-gray-200 hover:bg-gray-50 transition-all text-sm sm:text-base md:text-lg 2xl:text-xl">
                      ...
                      <td className="py-2 md:py-4 px-2 md:px-6">{item.Region}</td>
                      <td className="py-2 md:py-4 px-2 md:px-6">{item.popular}</td>
